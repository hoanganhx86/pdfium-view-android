...
class AnimationManager {
    ...
    class XAnimation implements AnimatorUpdateListener {
        ...
        public void onAnimationUpdate(ValueAnimator animation) {
            ...
            pdfView.moveTo(offset, pdfView.getPageRectF().top);
        }
    ...
    class YAnimation implements AnimatorUpdateListener {
        ...
        public void onAnimationUpdate(ValueAnimator animation) {
            float offset = (Float) animation.getAnimatedValue();
            pdfView.moveTo(pdfView.getPageRectF().left, offset);
        }
    ...
    class ZoomAnimation implements AnimatorUpdateListener, AnimatorListener {
        ...
        public void onAnimationUpdate(ValueAnimator animation) {
            ...
            pdfView.zoomCenteredTo(zoom, pdfView.getWidth() / 2, pdfView.getHeight() / 2);
        }
        ...
        public void onAnimationStart(Animator animation) {
            pdfView.mAccumulateScale = 1f;
            pdfView.isScaling = true;
        }
